...
interface Level2Round2ScreenProps {
  onNextLevelClick: (wasCorrect: boolean) => void;
  round: number;
}

const Level2Round2Screen: React.FC<Level2Round2ScreenProps> = ({ onNextLevelClick, round }) => {
  const [answer, setAnswer] = useState<null | boolean>(null);
  const [answered, setAnswered] = useState(false);

  const correctAnswer = true; // "Yes" is the correct answer for Level 2, Round 2
...
export default Level2Round2Screen;
