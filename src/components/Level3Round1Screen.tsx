...
interface Level3Round1ScreenProps {
  onNextLevelClick: (wasCorrect: boolean) => void;
  round: number;
}

const Level3Round1Screen: React.FC<Level3Round1ScreenProps> = ({ onNextLevelClick, round }) => {
  const [answer, setAnswer] = useState<null | boolean>(null);
  const [answered, setAnswered] = useState(false);

  const correctAnswer = true; // "Yes" is the correct answer for Level 3, Round 1
...
export default Level3Round1Screen;
