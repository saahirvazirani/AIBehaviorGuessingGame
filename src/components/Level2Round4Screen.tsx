...
interface Level2Round4ScreenProps {
  onNextLevelClick: (wasCorrect: boolean) => void;
  round: number;
}

const Level2Round4Screen: React.FC<Level2Round4ScreenProps> = ({ onNextLevelClick, round }) => {
  const [answer, setAnswer] = useState<null | boolean>(null);
  const [answered, setAnswered] = useState(false);

  const correctAnswer = false; // "No" is the correct answer for Level 2, Round 4
...
export default Level2Round4Screen;
