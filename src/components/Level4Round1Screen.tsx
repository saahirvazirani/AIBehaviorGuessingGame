...
interface Level4Round1ScreenProps {
  onNextLevelClick: (wasCorrect: boolean) => void;
  round: number;
}

const Level4Round1Screen: React.FC<Level4Round1ScreenProps> = ({ onNextLevelClick, round }) => {
  const [answer, setAnswer] = useState<null | boolean>(null);
  const [answered, setAnswered] = useState(false);

  const correctAnswer = true; // "Yes" is the correct answer for Level 4, Round 1
...
export default Level4Round1Screen;
